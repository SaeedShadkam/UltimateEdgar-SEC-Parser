...
class Disclosure_10K():
  ...
  def __init__(self, cik, TXT_Address, HTML_Address, Company_Name, Form_Type, Date_Filed, User_Api='saeed shadkam saeedshadkam70@gmail.com'):
    global Old_HTMLs
  ...
  @classmethod
  def Initializer(cls, observation: pd.Series, User_Api='saeed shadkam saeedshadkam70@gmail.com')->'Disclosure':
